...
namespace Inventart.Repos
{
    public class UserRepo
    {
        ...
        {
            bool success = true;
            var sp_call = "EXEC sp_user_settings_edit @i_user_guid, @i_first_name, @i_last_name, @i_default_tenant, @i_default_language";
        ...
        {
            var sp_call = "EXEC sp_user_list_role_all @i_tenant_code";
            DynamicParameters sp_params = new DynamicParameters(new { i_tenant_code = tenantCode });
            using (var connection = new SqlConnection(_csp.ConnectionString))
            {
        ...
        {
            bool success = true;
            var sp_call = "EXEC sp_user_role_change @i_user_guid, @i_tenant, @i_role";
